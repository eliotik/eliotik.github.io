...
- Uses Husky + lint-staged for pre-commit hooks (ESLint --fix then Prettier for js/mjs/cjs/ts/astro; Prettier for md/mdx/json/css/yml); CI runs `pnpm format:check`
